...
<?php echo (statusicon($vo["status"],1,$frontUrl,'hidden.gif','隐藏')); echo (statusicon($vo["istop"],1,$frontUrl,'istop.gif','置顶')); echo (statusicon($vo["recommend"],1,$frontUrl,'recommend.gif','推荐')); echo (attachstatus($vo["attach_image"],1,$frontUrl,'image.gif','图片')); ?></td>
		...
		<td>     <a href="<?php echo U('Article/modify',array('id'=>$vo['id'],'jump'=>$_SERVER['REQUEST_URI']));?>"><img src="__PUBLIC__/Admin/modify22px.gif" alt="编辑" align="absmiddle" /></a>　<a href="<?php echo U('Article/delete',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/delete.gif" alt="删除" align="absmiddle" /></a>　</td>
