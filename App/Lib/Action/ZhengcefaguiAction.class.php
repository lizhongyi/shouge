...

{
    ...
    {    //is_html(MODULE_NAME,$this->sysConfig['jingtai']); 
       ...
       // echo M('Category')->getLastSql();
        ...
        parent::getJoinList($condition, 'a.id DESC', $pages, C('DB_PREFIX').'zhengcefagui a', C('DB_PREFIX').'category b on a.category_id=b.id','a.*, b.biaozhi as biaozhi,b.title as cate');
    ...
    public function detail(){
	  ...
	  public function hdetail(){
        ...
        $this->assign('commentCount', $commentCount);
          ...
          parent::getJoinDetail(array("a.id={$titleId}", "id={$titleId}"), 'view_count', C('DB_PREFIX').'zhengcefagui a', C('DB_PREFIX').'category b on a.category_id=b.id','a.*, b.title as categoryName');
